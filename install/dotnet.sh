...
cat /etc/environment | grep -q "DOTNET_NOLOGO" || echo 'DOTNET_NOLOGO="1"' | tee -a /etc/environment
...
DOTNET_CLI_TELEMETRY_OPTOUT=1 DOTNET_PRINT_TELEMETRY_MESSAGE="false" DOTNET_NOLOGO="1" apt install -y dotnet10
